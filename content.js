...
const SITE = {
  ...
  journals: [
    ...
    { id: `J-13`, cite: `Metin Ozturk, Attai I. Abubakar, Rao N. B. Rais, Mona Jaber, Sajjad Hussain, Muhammad A. Imran (2022). Context-Aware Connectivity and Processing Optimization for IoT Networks. <i>IEEE Internet of Things Journal</i>, 9(17), 16028-16043. (<a href="https://ieeexplore.ieee.org/document/9716065">Link to the paper</a>)` },
    ...
    { id: `J-08`, cite: `Metin Ozturk, Attai I. Abubakar, João P. B. Nadas, Rao N. B. Rais, Sajjad Hussain, Muhammad A. Imran (2021). Energy optimization in Ultra-Dense Radio Access Networks via Traffic-Aware Cell Switching. <i>IEEE Transactions on Green Communications and Networking</i>, 5(2), 832-845. (<a href="https://arxiv.org/abs/2007.04133">Link to the paper</a>)` },
    { id: `J-07`, cite: `Kenechi G. Omeke, Michael S. Mollel, Metin Ozturk, Shuja Ansari, Lei Zhang, Qammer H. Abbasi, Muhammad A. Imran (2021). DEKCS: A Dynamic Clustering Protocol to Prolong Underwater Sensor Networks. <i>IEEE Sensors Journal</i>, 21(7), 9457-9464. (<a href="https://ieeexplore.ieee.org/document/9336626">Link to the paper</a>)` },
    { id: `J-06`, cite: `Syed M. Asad, Shuja Ansari, Metin Ozturk, Rao N. B. Rais, Kia Dashtipour, Sajjad Hussain, Qammer H. Abbasi, Muhammad A. Imran (2020). Mobility Management-Based Autonomous Energy-Aware Framework Using Machine Learning Approach in Dense Mobile Networks. <i>Signals</i>, 1 (2), 170-187. (<a href="https://www.mdpi.com/2624-6120/1/2/10">Link to the paper</a>)` },
    { id: `J-05`, cite: `Michael S. Mollel, Attai I.  Abubakar, Metin Ozturk, Shubi Kaijage, Michael Kisangiri, Ahmed Zoha, Muhammad A. Imran, Qammer H. Abbasi (2020). Intelligent Handover Decision Scheme Using Double Deep Reinforcement Learning. <i>Physical Communication</i>, 42, 101133. (<a href="https://www.sciencedirect.com/science/article/pii/S187449072030210X">Link to the paper</a>)` },
    { id: `J-04`, cite: `Ali Rizwan, Najah A. Ali, Ahmed Zoha, Metin Ozturk, Akram Alomaniy, Muhammad A. Imran, Qammer H. Abbasi (2020). Non-Invasive Hydration Level Estimation in Human Body Using Galvanic Skin Response. <i>IEEE Sensors Journal</i>, 20(9), 4891-4900. (<a href="https://ieeexplore.ieee.org/document/8955795">Link to the paper</a>)` },
    { id: `J-03`, cite: `Metin Ozturk, Mandar Gogate, Oluwakayode Onireti, Ahsan Adeel, Amir Hussain, Muhammad A. Imran (2019). A Novel Deep Learning Driven Low-Cost Mobility Prediction Approach for 5G Cellular Networks: The Case of the Control/Data Separation Architecture (CDSA). <i>Neurocomputing</i>, 358, 479-489. (<a href="https://www.sciencedirect.com/science/article/pii/S0925231219300438">Link to the paper</a>)` },
